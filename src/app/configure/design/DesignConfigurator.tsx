...
const DesignConfigurator = ({
  ...
  async function saveConfiguration() {
    try {
      ...
      toast({
        title: "Something went wrong",
        description: "There was a problem saving our config. Please try again.",
        variant: "destructive",
      });
    }
  }
    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      <div className="h-[37.5rem] flex flex-col w-full col-span-full lg:col-span-1 bg-white ">
        <ScrollArea className="relative flex-1 overflow-auto">
          <div
            className="absolute z-10 insex-x-0 bottom-0 h-12 bg-gradient-to-t from-white pointer-events-none "
            aria-hidden="true"
          />
                  ...
                  <div className="mt-3 flex items-center space-x-3">
                    {COLORS.map((color) => (
                      <Radio
                        ...
                        className={({ checked }) =>
                          cn(
                            "relative -m-0.5 flex cursor-pointer  justify-center items-center rounded-full p-0.5 active:ring-0 focus:ring-0 active:outline-none focus:outline-none border-2 border-transparent",
                            {
